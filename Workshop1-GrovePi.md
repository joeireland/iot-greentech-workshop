...
**NOTE: We could have used a thermocouple and the GrovePi+ sensor kit comes with one. However, for the purposes of this workshop it's easier to manipulate an angle sensor to simuluate temperature changes.**
